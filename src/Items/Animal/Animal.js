...
export default class Human extends Component{
    ...
    constructor(props){
        ...
        this.state={
            ...
            pickedSpecie:'',
            showPickedSpecie:true,
            showOtherSpecie:false,
            error:'',
        };
    }
    ...
    OnSubmitPost=(values)=>{
        ...
        if (uid){
            db.ref('Posts').push({
                ...
                createdAt:createdAt,
                updatedAt:createdAt,
                animalType:values.petSpecie,
                otherAnimalType:values.otherSpecie,
    ...
    OnSelectSpecie=(e)=>{
        this.setState({pickedSpecie: e});
            if (e === 'Other'){
                this.setState({showOtherSpecie:true})
            }else {
                this.setState({showOtherSpecie:false})
            }
    };
    render() {
            ...
            <Formik
                ...
                {(props)=>(
                    <View style={styles.inputs}>
                        ...
                        <Text style={{fontSize:18}}>Pets Specie</Text>
                        {this.state.showPickedSpecie && (
                        <Picker style={styles.inputPicker}
                                selectedValue={this.state.pickedSpecie}
                        ...
                        {this.state.showOtherSpecie && (
                            <TextInput
                                onChangeText={props.handleChange('otherSpecie')}
                                value={props.values.otherSpecie}
                                style={styles.input}
                                maxLength={40}
                                placeholder="Other"
